...
_HYPERPARAMS = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='select_model_using_cross_entropy', full_name='deepnet.Hyperparams.select_model_using_cross_entropy', index=62,
